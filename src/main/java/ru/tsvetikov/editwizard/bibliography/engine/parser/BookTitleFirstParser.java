...
@Component
public class BookTitleFirstParser implements BibliographyParser {

    @Override
    public boolean canParse(SourceType type) { return type == SourceType.BOOK_TITLE_FIRST; }
    ...
    public ParsedRecord parse(String rawLine) {
        ...
        int pos = TokenExtractor.extractTitleAndBlockAfterSlash(line, tokens, "AUTHORS");
        TokenExtractor.extractBookTail(line, pos, tokens);
        return new ParsedRecord(SourceType.BOOK_TITLE_FIRST, rawLine, tokens);
    }
}